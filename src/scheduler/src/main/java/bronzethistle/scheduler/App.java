...
public class App {
    ...
    private static final String[] CONFIGURATIONS = {
            "file:${bronzethistle-scheduler.home}/conf/bronzethistle-scheduler.properties"
    };
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            log.info("bronzethistle scheduler shut down.");
    ...
    private void init() {
        System.setProperty("bronzethistle-scheduler.home", homePath);
    ...
    public synchronized void start() {
        if (running) {
            throw new SchedulerException("Server is already running.");
        }
        init();
